...
cat("Grens waaronder 5% van alle data ligt:", qnorm(0.05, mu, sigma)," cm\n")


# 2) Boven welke lengte ligt 5% van alle data?

cat("Grens waarboven 5% van alle data ligt:", qnorm(0.95, mu, sigma)," cm\n")
```
...
Nee want het gemiddelde ligt binnen het 95% betrouwbaarheidsinterval.
